        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="https://app.aplusreviews.io/auth?tab=signup&utm_source=landing&utm_medium=website" className="text-gray-600 hover:text-gray-900">Get Started</a></li>
            </ul>
          </div>
