    ...
    <section id="pricing" className="py-24 lg:py-32 bg-[#FAFAFA]">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <p className="text-[#3C83F6] font-semibold text-sm tracking-wide uppercase mb-4">Pricing</p>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-10">
              <span className="bg-[#3C83F6] text-white px-5 py-1.5 rounded-full text-sm font-semibold shadow-lg shadow-blue-500/20">
                Most Popular
              </span>
            </div>
            <PricingCard
        ...
        <div className="text-center mt-24">
          <div className="max-w-xl mx-auto">
            ...
            <Button size="lg" className="bg-[#3C83F6] hover:bg-[#2563EB] text-white rounded-full px-8 h-14 text-lg font-semibold shadow-lg shadow-blue-500/20" asChild>
...
function PricingCard({
  ...
  return (
    <div className={`bg-white rounded-3xl p-8 h-full flex flex-col ${
      ...
      <p className={`text-sm text-center mb-8 ${ctaVariant === 'primary' ? 'text-[#3C83F6]' : 'text-gray-400'}`}>{ctaNote}</p>
